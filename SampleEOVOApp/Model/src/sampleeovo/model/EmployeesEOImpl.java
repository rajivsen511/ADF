...
public class EmployeesEOImpl extends EntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("sampleeovo.model.EmployeesEO");
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        ...
        Object postedLastName = getPostedAttribute(this.getAttributeIndexOf(LAST_NAME));
        
        Object employeeId = this.getAttribute(EMPLOYEE_ID);
        Object  lastName = this.getAttribute(LAST_NAME);
        ...
        if (lastName != null && !lastName.equals(postedLastName)) {
        System.out.println("lastName "+lastName);
            System.out.println("postedLastName "+postedLastName);
        }
